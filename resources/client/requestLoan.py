...
class RequestLoanResource(Resource):
	def post(self):
		try:
			...
			print('Calendar')
			rendered = render_template('calendar.html',currencySymbol=currency.currencySymbol,totalAmortization=totalAmortization,totalInterest=totalInterest,totalComission=totalComission,totalShare=totalShare)
